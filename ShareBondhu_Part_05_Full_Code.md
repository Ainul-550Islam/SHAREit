...
Complete source based only on ShareBondhu_Part_04.zip. No connected backend/provider or real funds are implied. All five new files appear in order, followed by complete required replacement files.
