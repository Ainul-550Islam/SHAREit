...
Complete source on the Part 5 baseline. All five new files are in order, followed by full integration/dependency replacements. Test catalogs/providers are not production integrations.
